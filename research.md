...
- **Diferenciação tecnológicas na agropecuária do nordeste brasileiro: uma análise comparativa entre seminário e não semiárido**, joint with [Márcio Corrêa](https://www.researchgate.net/profile/Marcio-Correa-3) and [Felipe Silva](https://scholar.google.com/citations?user=A2ZsTe0AAAAJ&hl=pt-BR).
